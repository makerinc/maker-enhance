...
var _browser = _interopRequireDefault(require("history/browser"));
...
function MakerEnhanceClient(_ref) {
  ...
  var _useState = (0, _react.useState)(isBrowser() ? getUrl() : undefined),
  ...
  (0, _react.useEffect)(function () {
    var unlisten = _browser["default"].listen(function (_ref2) {
